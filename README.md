...
├── offboarding/
│   └── offboard-essesseff-hello-world-flask-template.sh # script for offboarding the {{K8S_NAMESPACE}} namespace from K8s
...
1. **Git Clone This Repository**:
   ```bash
   git clone git@github.com:essesseff-hello-world-flask-template/hello-world-argocd-staging.git
   ```
...
6. **Access the Deployed Application**:
   ```bash
   kubectl port-forward service/hello-world-staging 8081:80 -n {{K8S_NAMESPACE}}
...
- **Config STAGING**: `https://github.com/essesseff-hello-world-flask-template/hello-world-config-staging`
- **Argo CD STAGING**: `https://github.com/essesseff-hello-world-flask-template/hello-world-argocd-staging` (this repo)
